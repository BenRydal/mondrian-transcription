class Keys {
     ...
     */
    drawLoadDataGUI() {
        this.pSketch.noStroke();
        this.pSketch.fill(225);
        this.pSketch.rect(this.displayFloorplanXpos, this.displayFloorplanYpos, this.displayFloorplanWidth, this.displayFloorplanHeight);
        this.pSketch.fill(200);
        this.pSketch.rect(this.displayVideoXpos, this.displayVideoYpos, this.displayVideoWidth, this.displayVideoHeight);
    }

    drawIntroScreen() {
        this.pSketch.rectMode(this.pSketch.CENTER);
        this.pSketch.stroke(0);
        this.pSketch.strokeWeight(1);
        this.pSketch.fill(255, 180);
        this.pSketch.rect(this.pSketch.width / 2, this.pSketch.height / 2, this.pSketch.width / 2 + this.keySpacing, this.pSketch.height / 2 + this.keySpacing);
        this.pSketch.fill(0);
        this.pSketch.textFont(this.font_Lato, this.keyTextSize);
        this.pSketch.text(this.infoMsg, this.pSketch.width / 2, this.pSketch.height / 2, this.pSketch.width / 2, this.pSketch.height / 2);
        this.pSketch.rectMode(this.pSketch.CORNER);
    }
}
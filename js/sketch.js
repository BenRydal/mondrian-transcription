...
const mondrian = new p5((sk) => {
    ...
    sk.setup = function () {
        ...
        sk.infoMsg = "MONDRIAN TRANSCRIPTION SOFTWARE\n\nby Ben Rydal Shapiro & contributors\nbuilt with p5.js & JavaScript\n\nHi there! This tool allows you to transcribe fine-grained movement data from video. To get started, use the top buttons to upload a floor plan image (PNG or JPG) and a video (MP4). Then, click anywhere on the floor plan to start recording movement data synchronized to the video. As you use your cursor to draw on the floor plan, positioning data is recorded organized by time in seconds and x/y pixel positions scaled to the pixel size of your floor plan image. Play/pause recording by clicking on the floor plan. Press ‘f’ to fast forward and ‘r’ to rewind video and data recording in 5 second intervals. Use the top buttons to clear or save your recording as a CSV file. For more information, see: https://www.benrydal.com/software/mondrian-transcription";
